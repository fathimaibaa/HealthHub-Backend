                        ...
                        <tr>
                            <td bgcolor="#ffffff" style="padding: 40px 30px;">
                                ...
                                <p style="text-align: center;">
                                    <a href="https://health-hub-one.vercel.app/user/reset_password/${verificationCode}" style="display: inline-block; padding: 12px 24px; background-color: #6b21a8; color: #ffffff; text-decoration: none; border-radius: 5px; font-weight: bold;">Reset Password</a>
                                </p>
