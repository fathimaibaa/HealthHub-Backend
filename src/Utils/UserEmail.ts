                        ...
                        <tr>
                            <td bgcolor="#ffffff" style="padding: 40px 30px;">
                                ...
                                <p style="text-align: center;">
                                    <a href="https://app.healthhubapp.online/${verificationCode}" style="display: inline-block; padding: 12px 24px; background-color: #6b21a8; color: #ffffff; text-decoration: none; border-radius: 5px; font-weight: bold;">Reset Password</a>
                                </p>
